...
## demo daphnia instructions

* Load the R scripts in chunk #1
* Run the chunk with the function demo_daphnia(). Run it from the console and not from the notebook otherwise it will take longer will not be able to see the animation.
...
library(ReacTran)
library(simecol)
source("../R/daphnia_deb_phyto.R")
source("../R/daphnia_deb_equations.R")
source("../R/daphnia_deb_lifeequations.R")
source("../R/daphnia_deb.R")
source("../R/daphnia_deb_ibm.R")
```
